...
export const validateKnjigeUpdate = (request, response) => {
...
export const validateAutorUpdate = (request, response) => {
...
export const validateAudioKnjigeUpdate = (request, response) => {
...
export const validatePloceUpdate = (request, response) => {
...
export const validateIzdavacUpdate = (request, response) => {
